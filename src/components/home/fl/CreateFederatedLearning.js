...
import CreateFederatedLearningForm from './CreateFederatedLearningForm';

class CreateFederatedLearning extends React.Component {
  constructor(props) {
    super(props);
    this.fetchGlobalJobs = this.props.fetchGlobalJobs;
    this.fetchLocalJobs = this.props.fetchLocalJobs;
  ...
  popover = () => (
    <Popover id='popover-basic'>
      ...
      <Popover.Body>
        <strong>Global Model Name</strong>
        <br></br>
        Name of the Global Model. <br></br>
    ...
    return (
      <>
        ...
        <CreateFederatedLearningForm
          ...
          // fetchLocalJobs={this.fetchLocalJobs}
        ></CreateFederatedLearningForm>
      </>
    );
  }
...
export default CreateFederatedLearning;
