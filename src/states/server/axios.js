...
// export const FLMgr_baseUrl = 'http://' + process.env.REACT_APP_FLMgr_HOST + ':' + process.env.REACT_APP_FLMgr_PORT;
...
export const FLMgr_baseUrl = 'http://localhost:32003';
...
export const fl_instance = axios.create({
  baseURL: FLMgr_baseUrl,
  headers: {
    'Content-Type': 'application/json',
  },
  timeout: 3000,
